...
public:
    ...
    RegistrierungsDialog( QWidget* parent, QString& roomName, QString& clientName,
                      QString& ipAddress, QString& ipAddress2, QString& clientGroup);
    ~RegistrierungsDialog();

signals:
    void finished(QString& roomName, QString& clientName, QString& ipAddress, QString& ipAddress2, QString& clientGroup);
